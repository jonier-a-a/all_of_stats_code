...
a_post = np.quantile(tau_post,0.05)
b_post = np.quantile(tau_post,0.95)
...
print(f'tau posterior mean (constant prior) {tau_hat:.3f}')
print(f'90% posterior interval for tau (constant prior) ({a_post:.3f},{b_post:.3f})')
print('############################')